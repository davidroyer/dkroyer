<template>
  <nav class="navbar">
    <div class="navbar-brand">
      ...
      <div class="nav-right">
        <a aria-label="Github profile" class="nav-item icon-link is-hidden-mobile is-hidden-desktop" href="https://github.com/davidroyer" rel="noopener" target="_blank">
        ...
        <a aria-label="Twitter profile" class="nav-item icon-link is-hidden-mobile is-hidden-desktop" href="https://twitter.com/DavidRoyer_" rel="noopener" target="_blank">
        ...
        <a aria-label="LinkedIn profile" class="nav-item icon-link is-hidden-mobile is-hidden-desktop" href="https://www.linkedin.com/in/dkroyer/" rel="noopener" target="_blank">
