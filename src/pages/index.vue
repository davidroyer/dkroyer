  ...
  <div class="home">
    ...
    <v-wrapper>
      <section class="about mt-0 mb-8 border-b-2">
        ...
        <p class="text-center"><strong class="list-header text-xl">Recent projects and accomplishments</strong></p>
        <ul>
          ...
          <li>Built a custom Vue.js filtering plugin allowing users on our clients' sites to quickly and easily find the degree they are looking for.</li>
